# clear; python DBSL_muf_sqrt.py -a='140.109.23.236' -w=5 -r= &
# server at gpu08
import argparse
import math
import os
...
class ParameterServer(object):
    ...
    def push_and_pull_model(ps_rref, worker_weights, worker_batch_size,
        ...
        with self.model_lock:
            ...
            if worker_batch_size == small_BS:
                update_factor = math.sqrt(small_data / base_data)
    ...
    def save_history(self):
        ...
        fname = f'tfsqrt_extra{extra_time_ratio}_{num_small}s_{small_BS}_{base_BS}'
